...
In order to generate docs again you can call `npm run hydration-tools:docs` command.
...
```bash
# Lint code
$ npm run hydration-tools:lint

# Run unit tests with coverage
$ npm run hydration-tools:test
```
...
`npm run hydration-tools:compare-json -- <path/to/file.json> <path/to/file.json>`

```bash
# Example
$ npm run compare-json test/data/.percyrc test/data/modified.percyrc

$ npm run hydration-tools:compare-json -- test/data/.percyrc test/data/modified.percyrc

# To generate HTML report
$ npm run compare-json test/data/.percyrc test/data/modified.percyrc -- --out ./test/data/out/diff.html

$ npm run hydration-tools:compare-json -- test/data/.percyrc test/data/modified.percyrc -- --out ./test/data/out/diff.html
```
...
`npm run hydration-tools:hydrate -- -- < --root | --app | --file > <path/to/input> --out <path/to/output>`
...
$ npm run hydration-tools:hydrate -- -- -r test/data/apps --out test/data/out/dist

# Process single app
$ npm run hydrate -- -a test/data/apps/shop --out test/data/out/dist/shop

$ npm run hydration-tools:hydrate -- -- -a test/data/apps/shop --out test/data/out/dist/shop

# Process single file
$ npm run hydrate -- -f test/data/apps/shop/app.config.yaml --out test/data/out/dist/shop

$ npm run hydration-tools:hydrate -- -- -f test/data/apps/shop/app.config.yaml --out test/data/out/dist/shop
```
...
$ npm run hydration-tools:hydrate.js -- -- -r test/data/apps --out test/data/out/dist

# Process single app
$ npm run hydrate.js -- -a test/data/apps/shop --out test/data/out/dist/shop

$ npm run hydration-tools:hydrate.js -- -- -a test/data/apps/shop --out test/data/out/dist/shop

# Process single file
$ npm run hydrate.js -- -f test/data/apps/shop/app.config.yaml --out test/data/out/dist/shop

$ npm run hydration-tools:hydrate.js -- -- -f test/data/apps/shop/app.config.yaml --out test/data/out/dist/shop

# compare-json Example
$ npm run compare-json.js test/data/.percyrc test/data/modified.percyrc

$ npm run hydration-tools:compare-json.js -- test/data/.percyrc test/data/modified.percyrc
```
